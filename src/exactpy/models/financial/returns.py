...
class ReturnModel(ExactOnlineBaseModel):
    ...
    frequency: ReturnFrequencyEnum = SparkField(spark_type="string")
    ...
    status: ReturnStatusEnum = SparkField(spark_type="integer")
    subject: str | None = SparkField(spark_type="string", default=None)
    type: ReturnTypeEnum = SparkField(spark_type="integer")
