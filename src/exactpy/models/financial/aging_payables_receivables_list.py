...
class AgingPayablesReceivablesListModel(ExactOnlineBaseModel):
    ...
    age_group1_amount: int | None = SparkField(spark_type="integer", default=None)
    ...
    age_group2_amount: int | None = SparkField(spark_type="integer", default=None)
    ...
    age_group3_amount: int | None = SparkField(spark_type="integer", default=None)
    ...
    age_group4_amount: float | None = SparkField(spark_type="float", default=None)
    ...
    total_amount: int | None = SparkField(spark_type="integer", default=None)
