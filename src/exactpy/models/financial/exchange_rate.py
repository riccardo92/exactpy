...
class ExchangeRateModel(ExactOnlineBaseModel):
    ...
    rate: float | None = GenericField(
        iceberg_type="double", spark_type="double", default=None
    )
    source_currency: str | None = GenericField(
        iceberg_type="string", spark_type="string", default=None
    )
    source_currency_description: str | None = GenericField(
        iceberg_type="string", spark_type="string", default=None
    )
    start_date: ExactUnixTimestamp = GenericField(
        iceberg_type="timestamp", spark_type="timestamp"
    )
    target_currency: str | None = GenericField(
        iceberg_type="string", spark_type="string", default=None
    )
    target_currency_description: str | None = GenericField(
        iceberg_type="string", spark_type="string", default=None
    )
