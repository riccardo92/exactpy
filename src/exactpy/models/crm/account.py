...
class AccountModel(ExactOnlineBaseModel):
    ...
    credit_line_purchase: float | None = SparkField(spark_type="float", default=None)
    credit_line_sales: float | None = SparkField(spark_type="float", default=None)
    ...
    discount_purchase: float | None = SparkField(spark_type="float", default=None)
    discount_sales: float | None = SparkField(spark_type="float", default=None)
